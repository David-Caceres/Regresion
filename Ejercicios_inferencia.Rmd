...
Hint: Use grid <- seq(-3, 3, length = 300) to create a grid of values, then use the dt()
function to compute the t-density on this grid and the lines() function to superimpose the
result.
...
#### (f) Use the bootstrap procedure from Section 3.6 to compute 90 % and 95 % confidence intervals for
β money . Does zero fall within these confidence intervals? Are these results consistent with previous
tests?
